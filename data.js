var jobTypes = {
	"Default":{
		percent:"35.0",
		mostSuscept: [{skill:"Microsoft Office",percent:"50.0"}, {skill:"Microsoft PowerPoint",percent:"50.0"}, {skill:"Microsoft Excel",percent:"50.0"}],
		leastSuscept: [{skill:"Communication",percent:"50.0"}, {skill:"Leadership",percent:"50.0"}]},
	"Representative":{
		percent:"65.0",
	...
	"Officer":{
		...
		leastSuscept: [{skill:"Customer Serivice",percent:"50.0"}, {skill:"Sales",percent:"50.0"}, {skill:"Bilingual",percent:"50.0"}]},
	"Analyst":{
		percent:"11.0",
		...
		leastSuscept: [{skill:"Banking",percent:"25.0"}, {skill:"Project Finance",percent:"17.0"}]},
	"Coordinator":{
		percent:"49.0",
